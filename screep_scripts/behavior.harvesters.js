...
var harvest_or_move = new btree.composites.select(
	[sbehave.creep.harvest_stack, sbehave.creep.succeeding_move_to_stack]);
...
var harvest_nearest_source = new btree.composites.sequence(
	[sbehave.creep.not_full_energy, sbehave.push_nearest_source, harvest_or_move, sbehave.pop_stack]);
